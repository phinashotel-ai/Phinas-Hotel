        ...
        <div className="relative mx-auto grid max-w-6xl gap-12 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-[#c7cec2] md:text-base">
              <li><Link href="/roomsearch" className="transition hover:text-[#fff8ed]">Our Rooms</Link></li>
              <li><Link href="#" className="transition hover:text-[#fff8ed]">About Us</Link></li>
              <li><Link href="#" className="transition hover:text-[#fff8ed]">Contact</Link></li>
            </ul>
          </div>
          <div>
