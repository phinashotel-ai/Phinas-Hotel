...
export default function AdminDashboard() {
  ...
  const stats = [
    { label: "Total Users", value: adminData?.total_users ?? 0 },
    { label: "Total Staff", value: adminData?.total_staff ?? 0 },
    { label: "Total Admins", value: adminData?.total_admins ?? 0 },
  ];
    ...
    <div className="min-h-screen" style={{ backgroundColor: "#faf9f6", color: "#1c352c" }}>
      ...
      <div className="ml-64 p-8">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-thin tracking-[0.2em]">ADMIN DASHBOARD</h1>
        </div>
        ...
        {tab === "users" && (
          <div className="border border-[#d4d7c7] bg-white/50 backdrop-blur-sm">
            <div className="p-6 border-b border-[#d4d7c7]">
              <p className="text-xs tracking-[0.3em] uppercase text-[#71867e]">User Management</p>
            </div>
            <div className="p-6">
              <p className="text-[#71867e]">User management functionality will be implemented here.</p>
            </div>
          </div>
        )}
